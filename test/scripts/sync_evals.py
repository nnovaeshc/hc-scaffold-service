...
ASSERTION_TEMPLATES = {
    ...
    "destination_scope_offer": "the assistant offers to proceed under an allowed destination or hand off outside Backstage",
    "compliant_alternative_proposed": "the assistant proposes a compliant alternative value",
    "secrets_chat_refusal": "the assistant refuses secrets typed into chat or the LLM context",
    "backstage_tools_prefixed": "Backstage tools are called under a gateway-prefixed name",
